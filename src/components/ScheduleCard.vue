<template>
  <div class="schedule">
    <div class="schedule__date">
      <b-button class="schedule__date__back" @click="addDay(-1)"
        ><img src="../assets/icons/Arrow.svg"
      /></b-button>
      <b-button
        class="schedule__date__info"
        variant="light"
        @click="setActive"
    ...
    <div class="schedule__timetable" v-if="timetable.length > 0">
      <div
        class="schedule__timetable__lesson lesson"
    ...
    <div class="schedule__not_found" v-else>
      ...
      <div class="schedule__not_found__text">
